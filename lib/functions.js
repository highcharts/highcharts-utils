...
export const replaceURLs = (str, codePath) => {
    ...
    // Controls, external repo
    ret = ret
        .replace(
            /https:\/\/code\.highcharts\.com\/controls\/controls.js/g,
            '/highcharts-controls/js/controls.js'
        )
        .replace(
            /https:\/\/code\.highcharts\.com\/css\/controls\/controls.css/g,
            '/highcharts-controls/css/controls.css'
        );
